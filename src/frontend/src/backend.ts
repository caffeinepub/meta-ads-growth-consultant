...
export class Backend implements backendInterface {
    ...
    async getSubmission(arg0: SubmissionId): Promise<Submission> {
        if (this.processError) {
            try {
    ...
    async submitAuditForm(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string): Promise<SubmissionId> {
        if (this.processError) {
            try {
                const result = await this.actor.submitAuditForm(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
